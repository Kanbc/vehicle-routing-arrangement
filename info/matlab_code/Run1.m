...
namefile=['result_' num2str(Num1) '_' num2str(Num2) '.mat'];
save(namefile,'station')

for ii=1:3

    datawrite=station((ii-1)*1e5+1:ii*1e5,:);
    name=['data_' num2str((ii-1)*1e5+1+Num1) 'to' num2str(ii*1e5+Num1) '.xlsx'];
